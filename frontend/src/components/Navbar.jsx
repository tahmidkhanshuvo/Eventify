 ...
 * JSX version of a "resizable" navbar similar to ui.aceternity.com’s demo.
 * - Sticky container
 * - On scroll: body narrows & adds blur
 * - Centered nav items with a soft hover highlight
...
function NavbarLogo() {
  return (
    <a href="#" className="relative z-20 mr-2 flex items-center space-x-2 px-2 py-1 text-sm font-normal text-black">
      <img
...
function NavbarButton({ href, as: Tag = "a", children, className, variant = "primary", ...props }) {
  const baseStyles =
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent shadow-none dark:text-white border border-zinc-200 hover:bg-zinc-50",
